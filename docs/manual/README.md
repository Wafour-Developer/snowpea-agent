...
| Plugins | Claude Code plugin format, SKILL.md, hooks, MCP, marketplaces | [en](en/plugins.md) | [ko](ko/plugins.md) | [ja](ja/plugins.md) | [zh-CN](zh-CN/plugins.md) | [es](es/plugins.md) |
