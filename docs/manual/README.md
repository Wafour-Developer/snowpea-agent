...
|---|---|---|---|---|---|---|
| Index | what snowpea is, where files live, how to get help | [en](en/index.md) | [ko](ko/index.md) | — | — | — |
...
| Backends | local, Docker, SSH | [en](en/backends.md) | [ko](ko/backends.md) | — | — | — |
| Headless | `-c`, JSON Lines, exit codes, CI | [en](en/headless.md) | [ko](ko/headless.md) | — | — | — |
| Protocol | handshake, methods, events, versioning and the freeze gate | [en](en/protocol.md) | [ko](ko/protocol.md) | — | — | — |
